...
func (l *ProxyOrderTranactionXFBLogic) ProxyOrderTranaction_XFB(ctx context.Context, in *transactionclient.ProxyOrderRequest) (resp *transactionclient.ProxyOrderResponse, err error) {
	tx := l.svcCtx.MyDB
	req := in.Req
	rate := in.Rate
