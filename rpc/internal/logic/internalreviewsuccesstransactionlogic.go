...
func (l *InternalReviewSuccessTransactionLogic) doUpdateBalance(db *gorm.DB, updateBalance types.UpdateBalance) (merchantBalanceRecord types.MerchantBalanceRecord, err error) {
	...
	if utils.FloatAddCWithTrancated(merchantBalance.Balance, updateBalance.TransferAmount) < 0 {
	...
	afterBalance = utils.FloatAddCWithTrancated(beforeBalance, updateBalance.TransferAmount)
...
func (l *InternalReviewSuccessTransactionLogic) doUpdatePtBalance(db *gorm.DB, updateBalance types.UpdateBalance) (err error) {
	...
	// 2. 計算
	var selectBalance string
	if utils.FloatAddCWithTrancated(merchantPtBalance.Balance, updateBalance.TransferAmount, merchantPtBalance.CurrencyCode) < 0 {
	...
	afterBalance = utils.FloatAddCWithTrancated(beforeBalance, updateBalance.TransferAmount, merchantPtBalance.CurrencyCode)
