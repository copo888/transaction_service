...
func (l *InternalReviewSuccessTransactionLogic) InternalReviewSuccessTransaction(in *transaction.InternalReviewSuccessRequest) (resp *transaction.InternalReviewSuccessResponse, err error) {
	...
	resp = &transaction.InternalReviewSuccessResponse{
		OrderNo: txOrder.OrderNo,
	}
